...
test_that("get_animals() allows selecting on animal_id", {
  # Errors
  expect_error(get_animals(credentials, animal_id = 0)) # Not an existing value
  expect_error(get_animals(credentials, animal_id = c(305, 0)))
  expect_error(get_animals(credentials, animal_id = 20.2)) # Not an integer

  # Select single value
  single_select <- 305
  single_select_df <- get_animals(credentials, animal_id = single_select)
  expect_equal(
  ...
  multi_select_df <- get_animals(credentials, animal_id = multi_select)
  expect_equal(
...
test_that("get_animals() allows selecting on animal_project_code", {
  # Errors
  expect_error(get_animals(credentials, animal_project_code = "not_a_project"))
  expect_error(get_animals(credentials, animal_project_code = c("2014_demer", "not_a_project")))

  # Select single value
  single_select <- "2014_demer"
  single_select_df <- get_animals(credentials, animal_project_code = single_select)
  expect_equal(
  ...
  multi_select_df <- get_animals(credentials, animal_project_code = multi_select)
  expect_equal(
...
test_that("get_animals() allows selecting on tag_serial_number", {
  # Errors
  expect_error(get_animals(credentials, tag_serial_number = "0")) # Not an existing value
  expect_error(get_animals(credentials, tag_serial_number = c("1187450", "0")))

  # Select single value
  single_select <- "1187450" # From 2014_demer
  single_select_df <- get_animals(credentials, tag_serial_number = single_select)
  expect_equal(
  ...
  multi_select_df <- get_animals(credentials, tag_serial_number = multi_select)
  expect_equal(
...
test_that("get_animals() allows selecting on scientific_name", {
  # Errors
  expect_error(get_animals(credentials, scientific_name = "not_a_sciname"))
  expect_error(get_animals(credentials, scientific_name = "rutilus rutilus")) # Case sensitive
  expect_error(get_animals(credentials, scientific_name = c("Rutilus rutilus", "not_a_sciname")))

  # Select single value
  single_select <- "Rutilus rutilus"
  single_select_df <- get_animals(credentials, scientific_name = single_select)
  expect_equal(
  ...
  multi_select_df <- get_animals(credentials, scientific_name = multi_select)
  expect_equal(
...
test_that("get_animals() collapses multiple associated tags to one row", {
  ...
  animal_two_tags_df <- get_animals(credentials, animal_id = 5841)
