...
test_that("get_cpod_projects() allows selecting on cpod_project_code", {
  # Errors
  expect_error(get_cpod_projects(credentials, cpod_project_code = "not_a_project"))
  expect_error(get_cpod_projects(credentials, cpod_project_code = c("cpod-lifewatch", "not_a_project")))
