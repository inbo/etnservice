...
pm.test("returns the right station names", () => {
      ...
      pm.expect(jsonData).to.include.members(["GARD5","ABDN Bay-4","PLANIER_EST","IMFSTP019","101 CORVO","F36","84-PONTA-CEDROS-FUNDO","bpns-HD17","C2","OM 3","LOM28","D1.11","SN_E12_C","I27","2021-O53","O32","Vossemeer","PTN_#78","LOM 37","IMFSTP035","CoastNet_PTN_Tejo_071","Pedra do Leao","NB028","ngOudm","gn-14","VB14","F22","SB45","Ler15","IM11","HVALPSUND5","FSUS","APPA E","L5","PREVOST_MER","Sound6","FRASERBURGH12","r02","s-12","Nene25","76 127 w                                                    ","gm_2017_13","Rt2","SB14","R 15","NB014","MR 23","G4"]);
  });
